...
cmd.should.eql "iq":{"@id":"123456","@type":"set","@to":"test.net","@from":"9001@cool.com/1","dial":{"@xmlns": "urn:xmpp:rayo:1", "@to":"tel:+13055195825","@from":"tel:+14152226789","header":[{"@name":"x-skill","@value":"agent"},{"@name":"x-customer-id","@value":"8877"}]}}
...
cmd.should.eql {"iq":{"@id":"123456","@type":"set","@to":"call57@test.net/1","@from":"9001@cool.com/1","reject":{"@xmlns":"urn:xmpp:rayo:1","decline":{},"header":[{"@name":"x-reason-internal","@value":"bad-skill"}]}}}
...
#>> Then
cmd.should.eql {"iq":{"@id":"123456","@type":"set","@to":"call57@test.net/1","@from":"9001@cool.com/1","say":{"@xmlns":"urn:xmpp:tropo:say:1","@voice":"allison","audio":[{"@src":"http://acme.com/greeting.mp3","text":"Thanks for calling ACME company"},{"@src":"http://acme.com/package-shipped.mp3","text":"Your package was shipped on"}],"say-as":{"@interpret-as":"date","text":"12/01/2011"}}}}
