(function() {
  ...
  Connection = (function() {
    ...
    function Connection(_arg) {
      var _ref, _ref2;
      this.server = _arg.server, this.jabberId = _arg.jabberId, this.jabberPass = _arg.jabberPass;
    ...
    Connection.prototype.handleError = function(stanza) {
      ...
      return cb(new Error((_ref = stanza.getChild().getText()) != null ? _ref : "Generic Stanza Error. Stanza: " + stanza));
    };
